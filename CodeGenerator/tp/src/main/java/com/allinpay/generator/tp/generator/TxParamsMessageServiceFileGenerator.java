/**
 * @(#) TxXmlMessageServiceFileGenerator.java
 ...
 * 序号	时间			作者			修改内容
 * 1.	2012-9-18	nilomiao	created this class.
 * </pre>
 */
public class TxParamsMessageServiceFileGenerator extends AbstractCodeGenerator {
	public TxParamsMessageServiceFileGenerator() {
		setTemplateFile("ebankTxParamsMessageService.html");
	...
	public File createEmptyGeneratedFile(String filePath, String fileName) {
		...
		String filepath = new StringBuffer(dir).append(File.separator)
				.append(StringUtil.capFirst(fileName)).append("TxParamsMessageService.java")
				.toString();
	...
	public String getName() {
		return "TxParamsMessageServiceFileGenerator";
	}
