 ...
 * </pre>
 */
public class TxXmlMessageServiceFileGenerator extends AbstractCodeGenerator {
	public TxXmlMessageServiceFileGenerator() {
		setTemplateFile("ebankTxXmlMessageService.html");
	...
	public File createEmptyGeneratedFile(String filePath, String fileName) {
		...
		String filepath = new StringBuffer(dir).append(File.separator)
				.append(StringUtil.capFirst(fileName)).append("TxXmlMessageService.java")
				.toString();
	...
	public String getName() {
		return "TxXmlMessageServiceFileGenerator";
	}
