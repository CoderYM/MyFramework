/**
 * @(#) OrderNoServiceFileGenerator.java
 ...
 * </pre>
 */
public class OrderNoServiceFileGenerator extends AbstractCodeGenerator {
	public OrderNoServiceFileGenerator() {
		setTemplateFile("ebankOrderNoService.html");
	...
	public File createEmptyGeneratedFile(String filePath, String fileName) {
		...
		String filepath = new StringBuffer(dir).append(File.separator)
				.append(StringUtil.capFirst(fileName)).append("OrderNoService.java").toString();
	...
	public String getName() {
		return "OrderNoServiceFileGenerator";
	}
