/**
 * @(#) SecurityServiceFileGenerator.java
 ...
 * </pre>
 */
public class SecurityServiceFileGenerator extends AbstractCodeGenerator {
	public SecurityServiceFileGenerator() {
		setTemplateFile("ebankSecurityService.html");
	...
	public File createEmptyGeneratedFile(String filePath, String fileName) {
		...
		String filepath = new StringBuffer(dir).append(File.separator)
				.append(StringUtil.capFirst(fileName)).append("SecurityService.java").toString();
	...
	public String getName() {
		return "SecurityServiceFileGenerator";
	}
