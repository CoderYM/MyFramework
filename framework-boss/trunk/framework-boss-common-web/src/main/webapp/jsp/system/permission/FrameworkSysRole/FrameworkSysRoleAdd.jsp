<%----------------------------------------------------------------------
  ...
  File Name:  FrameworkSysRoleAdd
  Detail   :  该页用于 FrameworkSysRole管理-FrameworkSysRole新增
----------------------------------------------------------------------%>
...
<form method="post" action="sysrole/saveFrameworkSysRoleAction?navTabId=sysrole&callbackType=closeCurrent" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone);">
<input id="v_pmcheck" type="hidden" name="pmcheckStrs" value=""/>
	...
	<legend>角色信息</legend>
		<p>
			<label>角色名</label>
			<input  type="text" name="sysRoleName" class="required"/>
		</p>
		<p>
			<label>角色描述</label>
			<input  type="text" name="sysRoleDescription" class=""/>
		</p>
	</fieldset>
	<fieldset>
	<legend>功能权限</legend>
		      
	<div class="accordion" style="width:600px;float:left;margin:10px;">
