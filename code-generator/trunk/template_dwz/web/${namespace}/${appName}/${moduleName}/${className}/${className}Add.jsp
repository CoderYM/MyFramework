	...
	<div class="pageFormContent" layoutH="56">
	 ...
	 <#if !column.pk>
	 	<p>
			...
			<#if !column.nullable>
			<input type="text" name="${column.columnNameLower}" class="required" maxlength="20"/>
			<#else>
			  	<#if column.isDateTimeColumn>
				<input type="text" name="${column.columnNameLower}" class="date" maxlength="20" dateFmt="yyyy-MM-dd HH:mm:ss" readonly="true"/>
				<a class="inputDateButton" href="javascript:;">选择</a>
			 	 <#else>
				<input type="text" name="${column.columnNameLower}" class="" maxlength="20"/>
				</#if>
			</#if>
		</p>
		</#if>
